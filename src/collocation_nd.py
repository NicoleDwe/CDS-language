...
def main():
    ...
    # save data as csv in current directory, as collocation_df
    data.to_csv(f"{keyword}_collocation_df.csv", index = False)
    
    # let the user know that the output is saved in the file name
    print(f"Output is saved as {keyword}_collocation_df.csv in current directory.")
